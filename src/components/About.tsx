...
export function AboutEng() {
  return (
    <>
      <div id="about" className="flex flex-col justify-center p-8">
        <h2 className=" text-2xl text-blue-600">
          About the Mirzaobod regional medical association
        </h2>

        <ul className="text-gray-500 content-center">
          <li>
          Mirzaobod District Medical Association Hospital is located at 40 Chinabot, Pakhtaabad city.
          ...
          <li>
          Mirzaobod District Medical Association has beds for 120 patients.
          </li>
          <li>
...
export function AboutRu() {
  return (
    <>
      <div id="about" className="flex flex-col justify-center p-8">
        <h2 className=" text-2xl text-blue-600">
        О Мирзаабадском районном медицинском объединении
        </h2>

        <ul className="text-gray-500 content-center">
          <li>
          Мирзаабадское районное медицинское объединение располагает койками на 120 больных.
